...
// These must match the constants in ObjShaderSpriteFont.geom and ObjShaderSpriteFont.frag
const unsigned int ObjLibrary :: SpriteFont :: PLAIN                = 0x0;
const unsigned int ObjLibrary :: SpriteFont :: BOLD                 = 0x1;
const unsigned int ObjLibrary :: SpriteFont :: MIRROR               = 0x2;
const unsigned int ObjLibrary :: SpriteFont :: ITALICS              = 0x4;
const unsigned int ObjLibrary :: SpriteFont :: SLANT                = 0x8;
const unsigned int ObjLibrary :: SpriteFont :: BACK_ITALICS         = 0xC;
const unsigned int ObjLibrary :: SpriteFont :: WIDE                 = 0x10;
const unsigned int ObjLibrary :: SpriteFont :: VERY_WIDE            = 0x20;
const unsigned int ObjLibrary :: SpriteFont :: NARROW               = 0x30;
const unsigned int ObjLibrary :: SpriteFont :: UNDERLINE            = 0x40;
const unsigned int ObjLibrary :: SpriteFont :: DOUBLE_UNDERLINE     = 0x80;
const unsigned int ObjLibrary :: SpriteFont :: RED_UNDERLINE        = 0xC0;
const unsigned int ObjLibrary :: SpriteFont :: STRIKETHROUGH        = 0x100;
const unsigned int ObjLibrary :: SpriteFont :: DOUBLE_STRIKETHROUGH = 0x200;
const unsigned int ObjLibrary :: SpriteFont :: RED_STRIKETHROUGH    = 0x300;
